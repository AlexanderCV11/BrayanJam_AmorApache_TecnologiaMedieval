...
void FBlueprintGetFriendsListDelegate_DelegateWrapper(const FMulticastScriptDelegate& BlueprintGetFriendsListDelegate, TArray<FBPFriendInfo> const& Results)
{
	...
	struct Z_CompiledInDeferFile_FID_Users_Alumnos_Documents_Unreal_Projects_CallOfTheKnight_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_GetFriendsCallbackProxy_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Alumnos_Documents_Unreal_Projects_CallOfTheKnight_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_GetFriendsCallbackProxy_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Alumnos_Documents_Unreal_Projects_CallOfTheKnight_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_GetFriendsCallbackProxy_h_1804630132(TEXT("/Script/AdvancedSessions"),
		Z_CompiledInDeferFile_FID_Users_Alumnos_Documents_Unreal_Projects_CallOfTheKnight_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_GetFriendsCallbackProxy_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Alumnos_Documents_Unreal_Projects_CallOfTheKnight_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_GetFriendsCallbackProxy_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
