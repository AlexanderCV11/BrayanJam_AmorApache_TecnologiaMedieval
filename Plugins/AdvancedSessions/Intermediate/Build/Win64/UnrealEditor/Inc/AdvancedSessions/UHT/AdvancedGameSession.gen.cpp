...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UClass_AAdvancedGameSession_Statics::NewProp_BanList_ValueProp = { "BanList", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 1, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AAdvancedGameSession_Statics::NewProp_BanList_Key_KeyProp = { "BanList_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FUniqueNetIdRepl, METADATA_PARAMS(nullptr, 0) }; // 2142661840
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AAdvancedGameSession_Statics::NewProp_BanList_MetaData[] = {
		{ "ModuleRelativePath", "Classes/AdvancedGameSession.h" },
	};
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_AAdvancedGameSession_Statics::NewProp_BanList = { "BanList", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AAdvancedGameSession, BanList), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AAdvancedGameSession_Statics::NewProp_BanList_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AAdvancedGameSession_Statics::NewProp_BanList_MetaData)) }; // 2142661840
	...
	struct Z_CompiledInDeferFile_FID_Users_Alumnos_Documents_Unreal_Projects_CallOfTheKnight_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_AdvancedGameSession_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Alumnos_Documents_Unreal_Projects_CallOfTheKnight_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_AdvancedGameSession_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AAdvancedGameSession, AAdvancedGameSession::StaticClass, TEXT("AAdvancedGameSession"), &Z_Registration_Info_UClass_AAdvancedGameSession, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AAdvancedGameSession), 4055100919U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Alumnos_Documents_Unreal_Projects_CallOfTheKnight_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_AdvancedGameSession_h_3025637869(TEXT("/Script/AdvancedSessions"),
		Z_CompiledInDeferFile_FID_Users_Alumnos_Documents_Unreal_Projects_CallOfTheKnight_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_AdvancedGameSession_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Alumnos_Documents_Unreal_Projects_CallOfTheKnight_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_AdvancedGameSession_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
